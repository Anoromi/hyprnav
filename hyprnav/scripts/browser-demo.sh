...
hyprnav tab open --name demo --url 'https://interactions-33e667f674b8cc14518350eea9255a5d.anoromi.com/?space=hyprnav-browser-demo'
...
for workspace in work personal research; do
  ...
  hyprnav tab assign --env hyprnav-browser-demo --slot "$slot" --name demo --workspace "$workspace"
done
